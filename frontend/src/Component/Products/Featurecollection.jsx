        ...
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-300 rounded-3xl ">
          ...
          <div className="lg:w-1/2 p-8 text-center lg:text-left">
            ...
            <p className="text-lg text-gray-600 mb-6">
              Discover high-quality , comfortable clothing that efoortlessly blends 
          ...
          <img src={feature} alt="Featured Collection" className="w-full h-full object-cover lg:rounded-tr-3xl lg:rounded-br-3xl" /></div>
        </div>
    </section>
  )
}
